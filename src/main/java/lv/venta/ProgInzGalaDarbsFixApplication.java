...
public class ProgInzGalaDarbsFixApplication {
	...
	public CommandLineRunner testModelLayer(IUserRepo userRepo, IPersonRepo personRepo, IStudentRepo studentRepo,
			IAcademicPersonelRepo personalRepo, ICourseRepo courseRepo, IThesisRepo thesisRepo,
		...
		return new CommandLineRunner() {
			...
			public void run(String... args) throws Exception {
				...
				Student s1 = new Student("Janis", "Berzins", "211221-34567", us3, "12345678", false);
				Student s2 = new Student("Baiba", "Kalnina", "121256-98765", us4, "12899876", true);
				Student s3 = new Student("Andris", "Ribakovs", "131256-98765", us7, "12799876", true);
				s2.addDebtCourse(c1);
				s2.addDebtCourse(c2);
				studentRepo.save(s1);
				studentRepo.save(s2);
				...
				Thesis th1 = new Thesis("Sistēmas izstrāde", "Development of System", "Development", "1...2.3..4", s1,
						ac1);
				Thesis th2 = new Thesis("Pētījums", "Research", "Research", "1...2.3..4", s2, ac2);
